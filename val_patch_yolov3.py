...
def run(
    ...
    if swarm_parameters == None:
        ...
        x = torch.tensor([[434.60690, 473.23517,  66.64682, 658.92328, 621.72919],
        [475.84329, 181.97731, 438.70361,  42.53031, 145.44824],
        [557.81360, 481.66949, 301.60242, 250.13504, 486.55969],
        [475.39020, 153.89401, 479.59796, 656.93677, 313.32068],
        [563.55505, 357.01794, 415.14145, 517.71411, 439.68399],
        [ 42.81420, 175.13602, 408.88480, 451.62869, 645.30908],
        [ 19.58222, 103.01709, 233.56038, 675.81891, 583.25226],
        [644.71075, 260.38660,  18.85740,  43.33541, 465.05591],
        [326.37036, 105.86214, 614.00793, 211.96519, 571.25134],
        [652.08936,  28.89998, 349.42282, 426.48660, 653.63672]], device='cuda:0')
...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default='../v0/config/data_config_one.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default="../checkpoints/yolov3_finetune.pt", help='model path(s)')
